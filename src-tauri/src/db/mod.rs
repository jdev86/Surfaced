...
pub fn establish_connection() -> SqliteConnection {
    ...
    let database_url = "sqlite.db";
    SqliteConnection::establish(&database_url)
        .unwrap_or_else(|_| panic!("Error connecting to {}", "sqlite.db"))
}

pub fn todos_create(conn: &SqliteConnection, body: &str) -> String {
    let new_todo = NewTodo { body };
